 ...
 * @public
 *
 * @param	{String}		sID								An ID
 * @param	{Object}		aGatewayOptions		An object of options for the Gateway
 ...
 *		new Core()
 */
var Core =  function( sID, aGatewayOptions, oCoreOptions ){
	var aGatewayOptions = [{
		id: 'Core',
		type: 'listen',
		connectionType: 'net',
	...
	Core.super_.call( this, 'Core', aGatewayOptions, oCoreOptions );
}
