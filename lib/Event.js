 ...
 */
class Event extends AncillaGenericObject {
  ...
  /**
	 ...
	 *
	 * @return	{Object}	It returns the current Event transformed into an answer
	 *
	 * @example
	 *   Event.toAnswer( Constant._NO_ERROR );
	 *   Event.toAnswer( oAdditionalData );
	 *   Event.toAnswer( Constant._NO_ERROR, oAdditionalData );
	 */
	toAnswer( iResultOrAdditionalData, oAdditionalData ){
