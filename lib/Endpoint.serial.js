...
class EmitterSerial {
	constructor( oOptions ){
		...
		//
		this.info('[ Endpoint Serial ( ID: %s ) ] Connected on port: "%s", BaudRate: %s, DataBits: %s, StopBits: %s, Parity: %s, BufferSize: %s', oOptions.id, oOptions.port, oOptions.baudrate, oOptions.databits, oOptions.stopbits, oOptions.parity, oOptions.buffersize );
