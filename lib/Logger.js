...
class Logger {
  ...
  configDefault( oDefaultOptions ){
		...
		this.__oOptionsDefault = _.extend( this.__oOptionsDefault, oDefaultOptions );
	}
  ...
  add( sID, sHeader, oOptions ){
    ...
    winston.loggers.get( sID ).filters.push( function(iLevel, sMsg){ return ( oOptions.sHeader  ? '[ ' + _Logger.__getTag( oOptions ) + ' ] ' : '' ) + sMsg; } );
    //
    if( oOptions.sLogPath ){
  ...
  __buildLoggerOptions( oOptions ){
    return _.extend( this.__oOptionsDefault, oOptions );
  }
